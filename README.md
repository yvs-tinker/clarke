...
We conducted a 47-respondent clinician survey, and Yash spoke to every clinician he worked with during his placements, which confirmed the ubiquity and severity of the problem. Respondents reported spending substantial time on documentation, identified clinical letter writing as the most time-consuming task, and expressed strong interest in AI-assisted documentation tools with EHR integration.
...
Clarke was built by a 4th-year medical student and a 1st-year electronic and information engineering student over the competition period. Development used Claude (Anthropic) for architectural design, evaluation methodology, and technical problem-solving, and Codex for code implementation via pull requests.
