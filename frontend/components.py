...
var aiEl=document.getElementById('clarke-audio-input');if(aiEl){var clearBtns=aiEl.querySelectorAll('button[aria-label="Clear"]');clearBtns.forEach(function(b){b.setAttribute('title','Re-record');});}})()" style="display:none;position:absolute;width:0;height:0;">
"""
